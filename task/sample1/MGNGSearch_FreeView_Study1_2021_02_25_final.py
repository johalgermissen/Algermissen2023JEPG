#!/usr/bin/env python2
# -*- coding: utf-8 -*-
__prj__ = 'Oyster Farming Task--Study 1'
...
def function_gui_info():
    ...
    "A. nRep": 22} # define dictionary with infos to be asked for
    ...
    if dialog.OK:
        ...
        nTrials = int(guiDict["A. nRep"]) * nCues * nSes; # number of cue repetitions per block: 
#        nTrials = 20
        ...
        return (subject, age, gender, hand, eye, isFull, useButtonBox, useEyeTracker, useGazeContingent, nTrials)
...
#    ## Compute points and overall catch accuracy:
    ...
    if euros > maxPayoff: # set to maxPayoff if bigger than maxPayoff
        euros = maxPayoff
...
(subject, age, gender, hand, eye, isFull, useButtonBox, useEyeTracker, useGazeContingent, nTrials) = function_gui_info()
...
if useButtonBox: 
    ...
    bb = serial.Serial("COM2", 115200) # initialize buttonbox
